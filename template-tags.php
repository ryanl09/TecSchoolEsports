...
function rookie_header_area() {
	...
	<div class="header-area header-area-custom<?php if ( isset( $options['logo_url'] ) ) { ?> header-area-has-logo<?php } ?><?php if ( $options['has_search'] ) { ?> header-area-has-search<?php } ?><?php if ( $options['display_header_text'] ) { ?> header-area-has-text<?php } ?>" style="background-image: url(<?php header_image(); ?>); <?php if (is_front_page()) { ?>height:600px;<?php }?>">
	<?php } else { ?>
	...
	<div class="playbtncontainer">
		<div class="playbtn">
			<img src="https://tecschoolesports.com/htdocs/wp-content/plugins/tecschoolesports/images/play.png">
		</div>
	</div>
	<div class="headerinfo">
		<strong><h1 class="mheaderhp">TEC Highschool League</h1><strong>
		<p class="mphp">Want to join for the 2022 Fall Season?</p>
		<button id="hpregister" class="hollowbtn mbuttonhp">Register here!</button>
	</div>
	<?php } ?>
